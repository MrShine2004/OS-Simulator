...
namespace ProjectOS
{
    public class OS
    {
        ...
        public int T_Load;     // Затраты на загрузку нового задания
        ...
        public long T_multi;    // Время работы модели с момента запуска
        public int M_multi;     // Число выполненных заданий с начала моделирования
        public long T_obor;     // Оборотное время (время между задачами) в тактах
        public long T_mono_all; // Время выполнения M_multi заданий в однопрограммной системе (в тактах)
        public long T_multi_all; // Время выполнения M_multi заданий в мультипрограммной системе (в тактах)
