...
namespace ProjectOS
{
    public class OS
    {
        ...
        public long T_mono_all; // Время выполнения M_multi заданий в однопрограммной системе
        public long T_multi_all; // Время выполнения M_multi заданий в мультипрограммной системе
